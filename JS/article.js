                    ...
                    <div style="background:rgba(255, 230, 4, 0.49); height:200px; width:800px; display:flex; border:2px solid #000033;" >    
                        <div style="display:flex;" class="image&title">
                            ...
                            <div class="article-content">
                                ...
                                <button type="submit" onclick="readSingleArticle(${blogValue.id})" style="height:20px; font-size:15px;margin-left:10px;"><a style="color:white"  href="/HTML-pages/readArticle.html">Read</a></button>
                              
                                <!--  <button type="submit" onclick="DeleteBlog(${articlePortion})" style="height:35px; font-size:15px;margin-left:10px;">Delete</button>   -->
